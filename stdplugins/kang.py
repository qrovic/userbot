...
async def _(event):
    ...
    packname = f"@theRay1 Brag pack"
    packshortname = f"theRay_Bragpack{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"theRay1_AnimatedStickers1"
        packshortname = f"theRay_Animated1"  # format: Uni_Borg_userid
    ...
    await event.edit("ruk BC karta hu................")
    ...
    await event.edit(f"hogya BC! idhar [Dekh](t.me/addstickers/{packshortname})")
